...
export const ProfessionalConstants: ProfessionalDataPoint[] = [
  {
    ...
    Description: `Designing, developing and maintaing gaming cloud services for 
        ...
        the expert on the Achievements, Leaderboards, Stats and Minutes Played services.
        During the search for a new manager for the team, my tech lead role has naturally 
        expanded to also include planning and guiding a team of junior engineers.`,
