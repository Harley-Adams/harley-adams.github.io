...
export default class PlayFabClient {
    ...
    public async GetTitleEntityToken(callback: (loginResult: EntityTokenResponse) => void) {
    ...
    public async LoginWithCustomId(customId: string, callback: (loginResult: PfLoginResult) => void) {
    ...
    public async GetEntityKey(entity: EntityTokenResponse, sessionToken: string, callback: (loginResult: EntityTokenResponse) => void) {
        let apiEndpoint = this.apiBase + `Authentication/GetEntityToken`;
    ...
    public GetV2Leaderboard(entityKey: string, statName: string, callback: (leaderboardResult: PfV2LeaderboardResult) => void) {
    ...
    public GetV2LeaderboardAroundPlayer(entityKey: string, statName: string, callback: (leaderboardResult: PfV2LeaderboardResult) => void) {
